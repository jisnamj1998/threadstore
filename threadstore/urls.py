...
urlpatterns = [
    ...
    path("basketitems/<int:pk>/remove/",views.CartDestroyView.as_view(),name="cart-remove"),
    path("signout",views.LogoutView.as_view(),name="signout"),
    path("basketitem/quantity/<int:pk>/change/",views.CartQuanityUpdateView.as_view(),name="quantity-update"),
